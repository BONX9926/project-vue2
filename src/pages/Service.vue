  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 img-responsive">
        <img align="right" src="../assets/image/bedroom.jpg" style="width: 400px;height: 267px;">
      </div>
      <div class="col-md-6">
    ...
    <div class="row">
  		<div class="col-md-6 img-responsive">
  			<img align="right" src="../assets/image/kitchen.jpg" style="width: 400px;height: 267px;">
  		</div>
  		<div class="col-md-6">
    		<h3>ห้องครัว</h3>
    		<ul>
     ...
     <div class="row">
      <div class="col-md-6 img-responsive">
        <img align="right" src="../assets/image/bathroom.jpg" style="width: 400px;height: 267px;">
      </div>
      <div class="col-md-6">
        <h3>ห้องน้ำ</h3>
        <ul>
     ...
     <div class="row">
       <div class="col-md-12">
        <p>
          ...
          การทำความสะอาดแบบ Big Cleaning** (งานทำความสะอาดหลังงานก่อสร้าง หรือ ไม่ได้ทำความสะอาดมาเกิน 2 เดือน), ทำความสะอาดหน้าต่างด้านนอกที่พัก, ขจัดคราบฝังลึก, กำจัดสิ่งรบกวน, กำจัดเชื้อรา, กำจัดแมลง
        </p>
       </div>
    </div>
  </div>
